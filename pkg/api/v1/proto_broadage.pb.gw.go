...
var (
	filter_BroadageService_GetPlayByPlay_0 = &utilities.DoubleArray{Encoding: map[string]int{"match_fid": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_BroadageService_GetPlayByPlay_0(ctx context.Context, marshaler runtime.Marshaler, client BroadageServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_BroadageService_GetPlayByPlay_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
